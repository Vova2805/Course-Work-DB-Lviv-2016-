...
( 
	...
	FULL_SALARY_PERSENTAGE NUMERIC(10,4) NOT NULL DEFAULT 100 ,
	THEME                INTEGER  NOT NULL DEFAULT 11,
...
( 
	...
	ENGAGED_SPACE        NUMERIC(18,2)  NOT NULL DEFAULT 0,
...
( 
	...
	CONSTRAINT R_149 FOREIGN KEY (WAREHOUSE_ID) REFERENCES WAREHOUSE(WAREHOUSE_ID),
...
( 
	...
	CONSTRAINT R_93 FOREIGN KEY (DELIVERY_ADDRESS_FROM) REFERENCES ADDRESS(ADDRESS_ID),
	CONSTRAINT R_155 FOREIGN KEY (DELIVERY_ADDRESS_TO) REFERENCES ADDRESS(ADDRESS_ID)
)
GO
