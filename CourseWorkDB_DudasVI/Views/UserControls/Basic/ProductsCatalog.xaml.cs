...
{
    public partial class ProductsCatalog : UserControl
    {
        ...
        private bool FilterProductsRule(object obj)
        {
            ...
            if (model != null)
            {
                ...
                if (product != null && (product.ProductInfo.PRODUCT_TITLE
                    .Contains(model.ChangedText, StringComparison.OrdinalIgnoreCase)
                                        ||
